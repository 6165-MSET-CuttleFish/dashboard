...
import com.dashboardPlus.config.Config;
...
public class FtcDashboard implements OpModeManagerImpl.Notifications {
    private static final String TAG = "com.dashboardPlus.FtcDashboard";
    ...
    private static final String PREFS_NAME = "com.dashboardPlus.FtcDashboard";
